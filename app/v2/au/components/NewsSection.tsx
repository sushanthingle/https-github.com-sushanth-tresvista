...
const NEWS = [
  {
    type: 'Press Release',
    title: 'TresVista Launches Enterprise Intelligence Orchestration Framework',
    brief: 'A new integrated model combining domain experts and AI for end-to-end enterprise intelligence.',
    cta: 'Read More',
    color: '#00327B',
  },
  {
    type: 'Media Coverage',
    title: 'TresVista Named Among Top Financial Services Firms',
    brief: 'Industry recognition for excellence in investment operations and enterprise AI adoption.',
    cta: 'Read More',
    color: '#347EF6',
  },
  {
    type: 'Event',
    title: 'TresVista at the Global Investment Forum',
    brief: 'Our team presented on the future of enterprise intelligence and AI-driven decision frameworks.',
    cta: 'Watch',
    color: '#00327B',
  },
]

const HEADLINE_LINES = ['TRESVISTA', 'IN THE NEWS']
...
export default function NewsSection() {
  ...
  return (
    <section
      id="news"
      ref={sectionRef}
      style={{ backgroundColor: '#ffffff', borderRadius: '64px 64px 0 0', marginTop: '-64px', position: 'relative', zIndex: 6 }}
    ...
    >
      ...
      <div ref={ref} className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-16">
        ...
        >
          <span className="text-[11px] font-bold tracking-[0.24em] uppercase text-tvblue">05</span>
          <motion.span
          ...
          />
          <span className="text-navy/30 text-[11px] font-bold tracking-[0.18em] uppercase">In the News</span>
        </motion.div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-10 mb-16 lg:mb-20">
          ...
          <motion.p
            ...
            className="text-navy/40 text-[13px] font-semibold tracking-[0.14em] uppercase leading-relaxed max-w-[300px]"
          >
            Press releases, media coverage, and events from across the TresVista network.
          </motion.p>
        </div>

        {/* News cards */}
        <motion.div style={{ y: cardsY }} className="grid lg:grid-cols-3 gap-5">
          {NEWS.map(({ type, title, brief, cta, color }, i) => (
            <motion.div
              key={title}
            ...
            >
              ...
              <div className="flex-1">
                <div style={{ overflow: 'hidden' }}>
                  <motion.h3
                    className="text-navy font-bold text-lg leading-snug mb-3"
                    initial={{ y: '110%' }}
                    animate={inView ? { y: 0 } : {}}
                ...
                <motion.p
                  ...
                  className="text-navy/45 text-sm leading-relaxed"
                >
                  {brief}
                </motion.p>
              </div>
